...
# Converting the list into a NumPy array so we can do bulk math on it
total_concentration = np.array(total_concentration)

# Sanity Check
# Ensuring blood plasma concentration never mathematically drops below absolute zero
if (total_concentration < 0).any():  # checks every number in the list
    print("Warning: Concentration dropped below zero. Correcting to 0.")
    total_concentration[total_concentration < 0] = 0
